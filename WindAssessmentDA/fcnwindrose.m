function varargout = fcnwindrose(D,F,varargin)
...
% Modified by Todd Schultz on June 11, 2009
% corrected meteorological angle conversion from D = mod(-90-D,360) to
%  D = mod(90-D,360), which correctly marks the direction as the source of
%  the wind, i.e. the direction the wind is blowing from.  
% Added hold off to end of main function
